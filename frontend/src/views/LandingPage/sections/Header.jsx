...
export default function Header() {
  ...
  return (
    <header className="flex justify-between items-center px-6 md:px-10 lg:px-16 h-[121px] sticky top-0 bg-white z-50 w-full">
      ...
      <nav className="hidden md:flex items-center font-sans mr-6 md:mr-10 lg:mr-20 space-x-6 md:space-x-10 lg:space-x-20 text-xl md:text-base lg:text-xl">
        ...
        <a href="#best-sellers" className="text-black font-normal hover:font-semibold hover:text-skpink hover:underline transition">
          Best Sellers
        </a>
      ...
      {isOpen && (
        <div className="absolute top-[121px] ml-20 w-full bg-white shadow-md flex flex-col items-start px-6 py-4 space-y-4 text-base font-sans md:hidden">
          ...
          <a href="#best-sellers" className="text-black font-normal hover:font-semibold hover:text-skpink hover:underline transition" onClick={() => setIsOpen(false)}>
            Best Sellers
          </a>
