// src/components/testimonials/TestimonialsView.jsx
...
const TestimonialsView = ({
  ...
  form,
  errors,
  editMode, // true if editing existing testimonial
  onPrevClick,
  onNextClick,
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center mb-8 md:mb-12">
        {!userHasTestimonial && (
          <button
            className="px-6 py-2 text-white rounded cursor-pointed shadow transition disabled:bg-gray-300 disabled:cursor-not-allowed"
        ...
        {userHasTestimonial && (
          <button
            ...
            style={{ backgroundColor: 'oklch(0.7589 0.1029 20.48)' }}
            onClick={() => {
              // Find the current user's testimonial to edit
      ...
      <div className="flex items-center justify-center gap-4 py-2">
        {/* Prev Button */}
        <button
          className={`p-2 rounded-full text-pink border transition ${
            canPrev
              ...
              <div className="mb-4">
                ...
                {form.avatar && (
                  <div className="mt-2 text-center">
                    <img src={form.avatar} alt="Preview" className="w-20 h-20 rounded-full object-cover mx-auto" />
                  </div>
                )}
              </div>
