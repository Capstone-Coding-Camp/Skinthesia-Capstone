...
const SunscreenPresenter = () => {
  ...
  useEffect(() => {
    try {
      ...
      console.log("Raw Data :", rawData[5]);
      console.log("Hero Data :", rawData[5].hero);
      const checkProduct = rawData[5].products.map(product => ({
        id: product.id,
...
export default SunscreenPresenter;