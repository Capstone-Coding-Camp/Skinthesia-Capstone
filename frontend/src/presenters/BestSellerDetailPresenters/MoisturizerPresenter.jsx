...
const MoisturizerPresenter = () => {
  ...
  useEffect(() => {
    try {
      ...
      console.log("Raw Data :", rawData[4]);
      console.log("Hero Data :", rawData[4].hero);
      const checkProduct = rawData[4].products.map(product => ({
        id: product.id,
...
export default MoisturizerPresenter;