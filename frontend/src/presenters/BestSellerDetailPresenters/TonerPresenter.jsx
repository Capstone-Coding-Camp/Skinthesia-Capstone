...
const TonerPresenter = () => {
  ...
  useEffect(() => {
    try {
      ...
      console.log("Raw Data :", rawData[1]);
      console.log("Hero Data :", rawData[1].hero);
      const checkProduct = rawData[1].products.map(product => ({
        id: product.id,
