...
const FacialWashPresenter = () => {
  ...
  useEffect(() => {
    try {
      ...
      console.log("Hero Data :", rawData[0].hero);
      const checkProduct = rawData[0].products.map(product => ({
        id: product.id,
...
export default FacialWashPresenter;