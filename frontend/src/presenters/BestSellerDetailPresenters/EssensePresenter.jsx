...
const EssensePresenter = () => {
  ...
  useEffect(() => {
    try {
      ...
      console.log("Raw Data :", rawData[2]);
      console.log("Hero Data :", rawData[2].hero);
      const checkProduct = rawData[2].products.map(product => ({
        id: product.id,
...
export default EssensePresenter;